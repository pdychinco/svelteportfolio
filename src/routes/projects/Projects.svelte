<script>
    import deepracer from '$lib/assets/deepracer.png'
    import tossup from '$lib/assets/tossup.png'
...
<div class="grid">
    ...
    <div>
        <h3><a href="https://github.com/pdychinco/flowerclassifier">Final Project of AWS AI/ML Scholarship Course - Flower Classifier</a></h3>
        <img src={flower} alt="Flower"/>
        <p>I coded Python script to read pictures and classify various species of flowers. After I created my own classifier and added it to a pretrained model. I had to modify the hyperparameters which resulted in a validation accuracy of 78%. Finally I created a command line tool to train and predict flowers using my classifier.</p>
    </div>
    <div>
        <h3><a href="https://comp1800-bby08-a726f.web.app">COMP 1800 Student Project - TossUp App</a></h3>
        <img src={tossup} alt="TossUp Web App"/>
